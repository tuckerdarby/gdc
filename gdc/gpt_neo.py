...
__all__ = ['ValueHead', 'GPTNeoHeadWithValueModel', 'respond_to_batch']
...
class ValueHead(nn.Module):
    """The ValueHead class implements a head for GPTNeo that returns a scalar for each output token."""
...
class GPTNeoHeadWithValueModel(GPTNeoPreTrainedModel):
    """The GPTNeoHeadWithValueModel class implements a GPTNeo language model with a secondary, scalar head."""
    def __init__(self, config):
